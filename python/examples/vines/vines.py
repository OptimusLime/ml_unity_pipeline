...
from examples.vines.utils import VT, VTA, BBOX2, Vector2, Viewport
from examples.vines.render import normalized_similarity, load_target, render_update
from examples.vines.render import make_gradient_weight_similarity_fct
...
class ProceduralVine():
    ...
    def _flip(self, name, p):
        return pyro.sample(name, dist.Bernoulli, p).sample()
